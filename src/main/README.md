...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 24ab96d9-3d9a-4152-af6b-d17e7e395d44
```

> `24ab96d9-3d9a-4152-af6b-d17e7e395d44` is the password of the certificate, you can change it to any password you want.
...
The application needs a database. Run the following command in the `Doctor.Appointment` directory to migrate the database and seed the initial data. This step is automatically done when you create a new solution, if you didn't especially disabled it.
